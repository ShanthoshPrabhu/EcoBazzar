...
function Header() {
   ...
   console.log(items)
  return (
   <div className=' max-w-screen-2xl pl-2 xl:text-lg text-xs sm:text-base md:text-base   flex h-8 items-center  xl:justify-between mt-6 xl:pl-12 xl:pr-8 text-[#1d9bf0] font-medium '>
      ...
      {/* <div className="bg-white items-center  w-1/2 flex rounded-full shadow-md  mb-5 sticky" > */}
          <input className="rounded-full w-[50%] ml-1  xl:w-1/2 h-9 xl:h-12 py-4 pl-6  text-gray-700  border-2 border-black border-opacity-10 bg-white focus:outline-none focus:transform focus:scale-105 lg:text-base xl:text-lg text-xs" type="text" />
       {/* </div> */}
